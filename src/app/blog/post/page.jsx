      ...
      <>
        ...
        <main className="pt-24 pb-16 bg-gray-50 min-h-screen" dir="rtl">
          <div className="max-w-4xl mx-auto px-6 text-center py-16">
            ...
            <Link to="/blog" className="text-[#4a9a10] font-bold hover:underline">
              العودة للمدونة
            </Link>
          </div>
        </main>
    ...
    <>
      ...
      <main className="pt-24 pb-16 bg-gray-50 min-h-screen" dir="rtl">
        <article className="max-w-4xl mx-auto px-6">
          <Link to="/blog" className="inline-flex items-center gap-2 text-[#4a9a10] font-bold mb-6 hover:underline">
